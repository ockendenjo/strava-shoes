...
require (
	...
	github.com/ockendenjo/handler v1.0.7
	github.com/ockendenjo/strava v0.0.0-20260603145130-dd922616efcd
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/lambda v1.97.0 // indirect
